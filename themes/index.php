                    ...
                    foreach($datas as $data){
                        ...
                        <div class="game-card-wrapper">
                            <a href="<?php echo get_url('/')?>view/<?php echo $data['slug'];?>" class="image-wrapper">
                                <div class="image"><img class=" ls-is-cached lazyloaded" src="https://spinplaneten.com/wp-content/uploads/2022/09/Rectangle-23-8.png" data-src="<?php echo $data['img'];?>" alt="game-image" /></div>
                            </a>
    ...
    <div class="container">
        <div class="hero-block">
            <div class="hero-title-wrapper">
                ...
                <a href="registration.php" class="main-button taimbroBTN"><span>Registrering</span></a>
            </div>
            <div class="hero-image-wrapper"><img class=" ls-is-cached lazyloaded" src="https://www.jackpotplaneten.com/wp-content/themes/sc-games-theme/assets/design-7/img/hero-image.png" data-src="https://www.jackpotplaneten.com/wp-content/themes/sc-games-theme/assets/design-7/img/hero-image.png" alt="hero-image" /></div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="content-block">
            <div class="wrapper">
                ...
                <img class=" ls-is-cached lazyloaded" src="https://monacofeber.com/wp-content/themes/sc-games-theme/assets/design-3/img/slot.png" data-src="https://monacofeber.com/wp-content/themes/sc-games-theme/assets/design-3/img/slot.png" alt="" />
            </div>
        </div>
    </div>
</section>
