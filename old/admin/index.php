...
<head>
  ...
  <title>Dashboard - Freelancing Guideline</title>
  ...
  <div class="main-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true" data-img="theme-assets/images/backgrounds/02.jpg">
    ...
    <div class="main-menu-content">
      <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
        ...
        <li class=" nav-item"><a href="add-data.php"><i class="la la-plus-circle"></i><span class="menu-title" data-i18n="">Add Data</span></a>
      </ul>
    </div>
      ...
      <div class="content-body">
            ...
            <div class="card">
              ...
              <div class="card-content collapse show">
                <div class="card-body pt-0">
                  <p class="card-text">Last <code class="highlighter-rouge">5</code> Data from Database</p>
                </div>
                  ...
                  <table class="table table-striped">
                    ...
                    <tbody>
                      ...
                      while ($table = mysqli_fetch_array($result)) {
                        $id = $mysqli->insert_id; ?>
                        <tr>
                          <th scope="row"> <?php echo "{$table['id']}\n"; ?></th>
                          <td><?php echo "{$table['title']}\n" ?></td>
                          <td><?php echo "{$table['image']}\n" ?></td>
                        </tr>
                      <?php } ?>
              ...
              <div class="card-content collapse show">
                ...
                <div class="table-responsive">
                  <table class="table table-striped">
                    ...
                    <tbody>
                      <?php
                      $sql = "SELECT * FROM `sub_category` ORDER BY ID DESC LIMIT 5";
                      $result = $conn->query($sql);
                      while ($table = mysqli_fetch_array($result)) {
                        $id = $mysqli->insert_id; ?>
                        <tr>
        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title">Instructor Profile List</h4>
                <a class="heading-elements-toggle"><i class="la la-ellipsis-v font-medium-3"></i></a>
              </div>
              <div class="card-content collapse show">
                <div class="card-body pt-0">
                ...
                <div class="table-responsive">
                  <table class="table table-striped">
                    ...
                    <tbody>
                      <?php
                      $sql = "SELECT * FROM `instructor_profile` ORDER BY ID DESC LIMIT 5";
                      $result = $conn->query($sql);
                      while ($table = mysqli_fetch_array($result)) {
                        $id = $mysqli->insert_id; ?>
                        <tr>
              ...
              <div class="card-content collapse show">
                ...
                <div class="table-responsive">
                  <table class="table table-striped">
                    ...
                    <tbody>
                      <?php
                      $sql = "SELECT * FROM `video_list` ORDER BY ID DESC LIMIT 5";
                      $result = $conn->query($sql);
                      while ($table = mysqli_fetch_array($result)) {
                        $id = $mysqli->insert_id; ?>
                        <tr>
